...
class SH_Jquery extends SH_Javascript {
	...
	{	
		...
		$controller = (strpos('://', $controller) === FALSE) ? $controller : $this->SH->config->site_url($controller);
		
		// ajaxStart and ajaxStop are better choices here... but this is a stop gap
		if ($this->SH->config->item('javascript_ajax_img') == '')
		{
			$loading_notifier = "Loading...";
		}
		else
		{
			$loading_notifier = '<img src=\'' . $this->SH->config->slash_item('base_url') . $this->SH->config->item('javascript_ajax_img') . '\' alt=\'Loading\' />';
		}
	...
	function _compile($view_var = 'script_foot', $script_tags = TRUE)
	{
		...
		$this->SH->load->vars(array('library_src' => $external_scripts));
		...
		$this->SH->load->vars(array($view_var => $output));
