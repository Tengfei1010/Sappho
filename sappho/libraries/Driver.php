...
class SH_Driver_Library {
	...
	function __get($child)
	{
		...
		// Remove the SH_ prefix and lowercase
		$lib_name = ucfirst(strtolower(str_replace('SH_', '', $this->lib_name)));
		$driver_name = strtolower(str_replace('SH_', '', $child_class));
