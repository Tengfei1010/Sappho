...
class SH_Cart {
	...
	public function __construct($params = array())
	{
		...
		$this->SH->load->library('session', $config);

		// Grab the shopping cart array from the session table, if it exists
		if ($this->SH->session->userdata('cart_contents') !== FALSE)
		{
			$this->_cart_contents = $this->SH->session->userdata('cart_contents');
		}
		else
		{
	...
	function _save_cart()
	{
		...
		{
			$this->SH->session->unset_userdata('cart_contents');
		...
		$this->SH->session->set_userdata(array('cart_contents' => $this->_cart_contents));
