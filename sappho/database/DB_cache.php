...
class SH_DB_Cache {
	 ...
	 * Constructor
	 *
	 * Grabs the SH super object instance so we can access it.
	 *
	 */
	function __construct(&$db)
	{
		// Assign the main SH object to $this->SH
		// and load the file helper since we use it a lot
		$this->SH =& get_instance();
		$this->db =& $db;
		$this->SH->load->helper('file');
	}
	...
	function read($sql)
	{
		...
		$segment_one = ($this->SH->uri->segment(1) == FALSE) ? 'default' : $this->SH->uri->segment(1);

		$segment_two = ($this->SH->uri->segment(2) == FALSE) ? 'index' : $this->SH->uri->segment(2);
