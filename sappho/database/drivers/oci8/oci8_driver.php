...
class SH_DB_oci8_driver extends SH_DB {
	...
	var $_commit = OSH_COMMIT_ON_SUCCESS;
	...
	public function stored_procedure($package, $procedure, $params)
	{
		...
		foreach ($params as $param)
		{
			...
			if (array_key_exists('type', $param) && ($param['type'] === OSH_B_CURSOR))
			{
				$have_cursor = TRUE;
			}
		}
	...
	public function trans_commit()
	{
		...
		$this->_commit = OSH_COMMIT_ON_SUCCESS;
		return $ret;
	}
