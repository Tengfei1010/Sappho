...
class SH_DB_driver {
	...
	{
		$driver = 'SH_DB_'.$this->dbdriver.'_result';
	...
	{
		if (is_object($this->CACHE) AND class_exists('SH_DB_Cache'))
		{
			return TRUE;
		}

		if ( ! class_exists('SH_DB_Cache'))
		{
		...
		$this->CACHE = new SH_DB_Cache($this); // pass db object to support multiple db connections and returned db objects
		return TRUE;
	}
