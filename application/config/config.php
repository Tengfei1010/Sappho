...
/*
// ::CONFIG/mongo_db/string:: Username to connect to
$config['username'] = 'database';

// ::CONFIG/mongo_db/string:: Password to connect to
$config['password'] = 'password';

// ::CONFIG/mongo_db/string:: Host to connect to
